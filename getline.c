 ...
 * Return: bytes read
 */
ssize_t input_buf(pops *pop, char **buf, size_t *len)
{
	ssize_t r = 0;
	size_t len_p = 0;
 ...
 * Return: r
 */
ssize_t read_buf(pops *pop, char *buf, size_t *i)
{
	ssize_t r = 0;

	if (*i)
		return (0);
	r = read(pop->readfd, buf, READ_BUF_SIZE);
	if (r >= 0)
		*i = r;
	return (r);
}
 ...
 * Return: s
 */
int _getline(pops *pop, char **ptr, size_t *length)
{
